...
A template of the module directory content can be found in the `customdemo` folder of the Dolibarr project at: https://github.com/Dolibarr/dolibarr/tree/develop/customdemo.
