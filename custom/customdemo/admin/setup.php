...
$formSetup->newItem('CUSTOMDEMO_MYPARAM5')->setAsYesNo();	 // ->fieldParams['alertifoff'] = 1 or ->fieldParams['alertifon'] = 1;
...
$formSetup->newItem('CUSTOMDEMO_CATEGORY_ID_XXX')->setAsCategory('product');
...
$item = $formSetup->newItem('CUSTOMDEMO_MYPARAM11')->setAsHtml();
$item->nameText = $item->getNameText().' more html text ';
$item->fieldInputOverride = '';
$item->helpText = $langs->transnoentities('HelpMessage');
$item->cssClass = 'minwidth500';

$item = $formSetup->newItem('CUSTOMDEMO_MYPARAM12');
$item->fieldOverride = "Value forced, can't be modified";
$item->cssClass = 'minwidth500';

//$item = $formSetup->newItem('CUSTOMDEMO_MYPARAM13')->setAsDate();	// Not yet implemented
...
$help_url = '';
$title = "CustomDemoSetup";

llxHeader('', $langs->trans($title), $help_url, '', 0, 0, '', '', '', 'mod-customdemo page-admin');
...
print dol_get_fiche_head($head, 'settings', $langs->trans($title), -1, "customdemo@customdemo");
